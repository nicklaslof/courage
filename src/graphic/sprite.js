class Sprite{
    ...
    render(game){
        ...
        game.gl.img(game.texture.glTexture.tex,-this.sizeX/2,-this.sizeY/2,this.sizeX,this.sizeY,this.rotation,this.x+(this.sizeX/2)+this.renderOffsetX,this.y+(this.sizeY/2)+this.renderOffsetY,1,1,this.u0, this.u1, this.v0, this.v1);
    }
