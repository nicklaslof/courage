    ...
    tick(game,deltaTime){
        ...
        if (this.spitOnPlayer){
            ...
            if (this.spitDelay <= 0){
                ...
                game.screen.level.addEntity(new Bullet(this.x+16,this.y,1000,200,this.calculatePlayerDirectionVector.x, this.calculatePlayerDirectionVector.y,this,0xff00ff00));
